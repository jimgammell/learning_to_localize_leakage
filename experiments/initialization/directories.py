...
def init_directories(clargs: Optional[Dict[str, str]] = None, config: Optional[Dict[str, str]] = None):
    global ASCADV1_FIXED_ROOT, ASCADV1_VARIABLE_ROOT, CHES_CTF_2018_ROOT, DOWNLOADS_CACHE_ROOT, OUTPUTS_ROOT
...
__all__ = [
    'ASCADV1_FIXED_ROOT', 'ASCADV1_VARIABLE_ROOT', 'CHES_CTF_2018_ROOT',
