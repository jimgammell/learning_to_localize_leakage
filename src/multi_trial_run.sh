...
python src/run_trials.py --seed-count=5 --config-file=nucleo run-real-trials --run-supervised-trials
python src/run_trials.py --seed-count=5 --config-file=nucleo run-real-trials --run-all-trials
python src/run_trials.py --seed-count=5 --config-file=nucleo run-real-trials --run-parametric-trials
